    ...
    <?php if ( ! Red_Headed_Soft_Lock::is_pro() ) : ?>
        <div class="pl-locked-pane">
            ...
            <ul class="pl-list-check">
                ...
                <li>✓ <?php esc_html_e( 'HMAC SHA-256 signature in X-Red_Headed_Pro-Signature', 'red-headed-pro' ); ?></li>
    ...
    ?>
        <form method="post" class="pl-form pl-card">
            ...
            <label class="pl-field">
                ...
                <input type="url" name="url" required placeholder="https://example.com/webhooks/red-headed-pro" />
            </label>
            <label class="pl-field">
            ...
            <p>
                <button type="submit" name="rh_hook_add" class="pl-btn pl-btn-primary"><?php esc_html_e( '💾 Save webhook', 'red-headed-pro' ); ?></button>
            </p>
        </form>
                        ...
                        <tr>
                            ...
                            <td>
                                <form method="post" style="display:inline">
                                    ...
                                    <button type="submit" name="rh_hook_del" value="<?php echo esc_attr( $h['url'] ); ?>" class="pl-btn pl-btn-sm pl-btn-danger" onclick="return confirm('<?php echo esc_js( __( 'Remove this webhook?', 'red-headed-pro' ) ); ?>');">×</button>
                                </form>
                            </td>
                        </tr>
                    <?php endforeach; ?>
...
User-Agent: Red_Headed_Pro/<?php echo esc_html( RED_HEADED_VERSION ); ?>

X-Red_Headed_Pro-Event: export.generated
X-Red_Headed_Pro-Site: <?php echo esc_html( home_url() ); ?>

X-Red_Headed_Pro-Signature: sha256=&lt;HMAC-SHA256(body, secret)&gt;</pre>
            </div>
            <div class="pl-card" style="padding:12px;">
  ...
  "version": "<?php echo esc_html( RED_HEADED_VERSION ); ?>"
}</pre>
            </div>
            <div class="pl-card" style="padding:12px;">
  ...
  ...
        ...
        <p class="pl-muted" style="margin-top:12px;font-size:11px;">
            <?php esc_html_e( 'Verify: hash_hmac("sha256", $raw_body, $your_secret) === str_replace("sha256=","", $header["X-Red_Headed_Pro-Signature"])', 'red-headed-pro' ); ?>
        </p>
    <?php endif; ?>
</div>
