...
<div class="pl-pane">
    ...
    <form method="post" class="pl-form">
        ...
        <fieldset class="pl-card">
            ...
            <label class="pl-field">
                ...
                <select name="decimal_sep">
                    <option value="dot"   <?php selected( get_option( 'red_headed_decimal_separator', 'dot' ), 'dot' ); ?>>. (<?php esc_html_e( 'dot — international', 'red-headed-pro' ); ?>)</option>
                    <option value="comma" <?php selected( get_option( 'red_headed_decimal_separator', 'dot' ), 'comma' ); ?>>, (<?php esc_html_e( 'comma — France/EU', 'red-headed-pro' ); ?>)</option>
                </select>
            </label>
            ...
            <label class="pl-field">
                ...
                <small class="pl-muted"><?php esc_html_e( 'Files older than this are auto-deleted from /uploads/red-headed-pro/exports. 0 = keep forever.', 'red-headed-pro' ); ?></small>
            </label>
        </fieldset>

        <fieldset class="pl-card">
            <legend class="pl-card-title">🏷️ <?php esc_html_e( 'Custom order status', 'red-headed-pro' ); ?> <?php echo wp_kses_post( Red_Headed_Soft_Lock::badge() ); ?></legend>
        ...
        <fieldset class="pl-card">
            ...
            <p class="pl-muted">
                <?php esc_html_e( 'Translatable via PolyLang & WPML — use the “Red_Headed_Pro” string group in the language admin.', 'red-headed-pro' ); ?>
            </p>
            <label class="pl-field">
        ...
        <fieldset class="pl-card">
            ...
            <p class="pl-muted">
                <?php esc_html_e( 'When ON (default), deleting Red-Headed from Plugins removes its options (settings, webhooks, cron flags), the rh_profiles + rh_jobs tables and the red_headed_cron_tick cron. Tables are preserved if the sister edition (Pro/Lite) is still installed. Turn OFF if you plan to reinstall later.', 'red-headed-pro' ); ?>
            </p>
        </fieldset>

        <p>
            <button type="submit" name="rh_general_save" class="pl-btn pl-btn-primary"><?php esc_html_e( '💾 Save settings', 'red-headed-pro' ); ?></button>
        </p>
    </form>
    ...
    <fieldset class="pl-card">
        ...
        <form method="post" style="margin:0">
            ...
            <button type="submit" name="rh_purge_jobs" class="pl-btn" onclick="return confirm('<?php echo esc_js( __( 'Purge old job rows? This cannot be undone.', 'red-headed-pro' ) ); ?>');"><?php esc_html_e( 'Purge old jobs', 'red-headed-pro' ); ?></button>
        </form>
    </fieldset>
